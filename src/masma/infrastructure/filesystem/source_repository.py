...
from masma.domain.errors import InputValidationError, SourceAccessError
from masma.domain.model import SourceUnit, SourceUnitId
from masma.domain.ports import SourceRepository
...
class FileSystemSourceRepository(SourceRepository):
    ...
    def list_source_units(self, root_path: str) -> tuple[SourceUnit, ...]:
